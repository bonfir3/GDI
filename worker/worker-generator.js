...
const jsURL = 'https://raw.githubusercontent.com/bonfir3/GDI/master/worker/worker-super.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Jaguar Drive Index';
